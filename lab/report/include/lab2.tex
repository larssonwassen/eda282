...
In \reffig{fig:lab2} the results from running the parallelized version of the program in the simulator with the different CCP:s and three different matrix dimensions.
