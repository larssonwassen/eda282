...
In the producer consumer benchmark, the reading threads transition the data element to the E state when accessing the array for the first time if the writing thread have not accessed it already. However, the whole counter array is shared and thus will not the E state be of any gain. Therefore, MSI and MESI performs equally regardless of working set size, which is shown in \reffig{fig:resultslab1}.
