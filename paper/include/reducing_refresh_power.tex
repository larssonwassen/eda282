...
\label{sec:red}
\todo[inline]{Do an intro that includes a road map, mention the refresh scheduling approach that schedules real access together with refresh ops. Make an intro to ARTV (somewhat done) }
